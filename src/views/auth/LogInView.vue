        ...
        <div class="col-lg-5 col-md-8 py-8 py-xl-0">
          ...
          <div class="card shadow">
            ...
            <div class="card-body p-6 d-flex flex-column gap-4">
              <div>
                <!--                <a href="templates/index.html"><img src="/assets/images/brand/logo/logo-icon.svg" class="mb-4"-->
                <!--                                                    alt="logo-icon"/></a>-->
              ...
              <form class="needs-validation" @submit.prevent="handleSubmit">
                ...
                <div class="mb-3">
                  ...
                  <input v-model="user.email" type="email" id="signInEmail" class="form-control"
                ...
                <div class="mb-3">
                  ...
                  <input v-model="user.password" type="password" id="signInPassword" class="form-control"
                ...
                <div class="d-lg-flex justify-content-between align-items-center mb-4">
                  <div class="form-check">
                    <input type="checkbox" v-model="user.rememberMe" class="form-check-input" id="rememberme" />
                ...
                <div>
                  ...
                  <div class="d-grid">
                    ...
                    <quiz-button class="btn btn-primary" :is-loading="isLoading"> Log In</quiz-button>
                  </div>
                </div>
                <hr class="my-4"/>
