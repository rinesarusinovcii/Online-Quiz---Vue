...
const handleSubmit = async () => {
  if (!newUser.name || !newUser.surname || !newUser.birthdate ||
      !newUser.username || !newUser.email || !newUser.role || !newUser.password) {
  ...
  await withLoading(async () => {
    ...
    if (registerStore.successMessage) {
      toast.showSuccess(registerStore.successMessage);
      await router.push({ name: 'login' });
    } else if (registerStore.errorMessage) {
      toast.showError(registerStore.errorMessage);
    }
  });
};
</script>
            ...
            <div class="card-body p-6 d-flex flex-column gap-4">
              ...
              <form class="needs-validation" @submit.prevent="handleSubmit">
                <div class="mb-3">
                  ...
                  <input v-model="newUser.name" type="text" class="form-control" id="signUpName"
                ...
                <div class="mb-3">
                  ...
                  <input v-model="newUser.surname" type="text" class="form-control" id="signUpSurname"
                ...
                <div class="mb-3">
                  ...
                  <input v-model="newUser.birthdate" type="date" id="birthdate" class="form-control"
                ...
                <div class="mb-3">
                  ...
                  <input v-model="newUser.username" type="text" class="form-control" id="signUpUserName"
                ...
                <div class="mb-3">
                  ...
                  <input v-model="newUser.email" type="email" class="form-control" id="signUpEmail"
                ...
                <div class="mb-3">
                  ...
                  <select v-model="newUser.role" id="role" class="form-select" required>
                ...
                <div class="mb-3">
                  ...
                  <input v-model="newUser.password" type="password" class="form-control" id="signUpPassword"
