    ...
    <div class="collapse navbar-collapse" id="sidenav">
      <div class="navbar-nav flex-column">
        ...
        <ul class="list-unstyled ms-n2 mb-4">
          ...
          <!-- Nav item -->
          <li class="nav-item">
            <router-link :to="{name:'new-quiz'}" class="sidebar-link">
              <i class="bi bi-grid-fill"></i>
          ...
          <!-- Nav item -->
          <li class="nav-item">
            <router-link :to="{name:'quiz'}" class="sidebar-link">
              <i class="bi bi-grid-fill"></i>
          ...
          <!-- Nav item -->
          <li class="nav-item">
            <router-link :to="{name:'question'}" class="sidebar-link">
              <i class="bi bi-grid-fill"></i>
        ...
        <ul class="list-unstyled ms-n2 mb-0">
          ...
          <!--                                    </li>-->
          <form>
            <!--            <button class="dropdown-item" type="submit" formaction="/logout" formmethod="post">Log Out</button>-->
          </form>
        </ul>
      </div>
    </div>
